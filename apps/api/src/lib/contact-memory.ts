...
export async function updateContactMemory(args: {
  ...
  try {
    ...
    const sys = [
      ...
      'Drop small talk, one-off questions, and anything not worth remembering next time. The "persona" is one short paragraph — for a prospect, summarise WHO they are and WHERE Hader fits.',
